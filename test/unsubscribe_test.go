...
func TestUnsubscribe1(t *testing.T) {
    ...
    msg.SetPacketIdentifier(1000)
    msg.SetPayload([]string{
        "test1",
        "test1",
        "test1",
    })
    ...
    msg2 := message.NewUnsubscribeMessage()
...
func TestUnsubscribe2(t *testing.T) {
    ...
    t.Log(msg2.(*message.UnsubscribeMessage).GetPacketIdentifier())
}
